...
local servico = false
local selecionado = 0
local CoordenadaX = 128.02
local CoordenadaY = -1944.85
local CoordenadaZ = 20.62
local processo = false
local segundos = 0
-- 128.02 ,-1944.85 ,20.62 
-----------------------------------------------------------------------------------------------------------------------------------------
-- RESIDENCIAS
-----------------------------------------------------------------------------------------------------------------------------------------
local locs = {
			...
			if distance <= 3 then
				...
				if distance <= 1.2 then
					...
					if IsControlJustPressed(0,38) then
						...
						TriggerEvent("Notify","sucesso","Entregue as Cocaínas.")
					end
				end
			end
		end
...
function CriandoBlip(locs,selecionado)
	...
	AddTextComponentString("Entregar Cocaína")
