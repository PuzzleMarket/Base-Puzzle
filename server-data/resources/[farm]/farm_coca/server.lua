...
function emP.checkPayment()
	...
	if user_id then
		if vRP.tryGetInventoryItem(user_id,"cocaina",quantidade[source]) then
			vRP.giveInventoryItem(user_id,"dinheirosujo", (parseInt(131) + bonus) * quantidade[source])
			TriggerClientEvent("vrp_sound:source",source,'coins',0.3)
			TriggerClientEvent("Notify",source,"sucesso","Você entregou "..quantidade[source].." Cocaínas.") 
		end
