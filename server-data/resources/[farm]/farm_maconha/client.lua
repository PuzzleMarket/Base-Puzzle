...
local servico = false
local selecionado = 0
local CoordenadaX = -116.87
local CoordenadaY = -1562.57
local CoordenadaZ = 34.24
local processo = false
local segundos = 0

-- -116.87 ,-1562.57 ,34.24
-----------------------------------------------------------------------------------------------------------------------------------------
-- RESIDENCIAS
-----------------------------------------------------------------------------------------------------------------------------------------
local locs = {
			...
			if distance <= 3 then
				...
				if distance <= 1.2 then
					...
					if IsControlJustPressed(0,38) then
						...
						TriggerEvent("Notify","sucesso","Entregue as Maconhas.")
					end
				end
			end
		end
	...
	while true do
		...
		if servico then
			...
			if distance <= 10 then
				...
				if distance <= 1.2 then
					drawTxt("PRESSIONE  ~r~E~w~  PARA ~y~ENTREGAR AS DROGAS",4,0.5,0.90,0.50,255,255,255,200)
...
function CriandoBlip(locs,selecionado)
	...
	AddTextComponentString("Entregar Baseados")
