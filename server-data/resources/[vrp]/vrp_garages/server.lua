...
local garages = {
	...
	[29] = { ['name'] = "Taxista", ['payment'] = false, ['perm'] = "livre" },
	...
	[38] = { ['name'] = "BarcosVip", ['payment'] = false, ['perm'] = "barcos.permissao" },
	[39] = { ['name'] = "BarcosVip", ['payment'] = false, ['perm'] = "barcos.permissao" },
	[40] = { ['name'] = "Embarcações", ['payment'] = false, ['perm'] = "livre" },
	[41] = { ['name'] = "BarcosVip", ['payment'] = false, ['perm'] = "barcos.permissao" },
	[44] = { ['name'] = "Motoclub", ['payment'] = true, ['perm'] = "motoclub.permissao" },
	[45] = { ['name'] = "Motoclub", ['payment'] = true, ['perm'] = "motoclub.permissao" },
	[46] = { ['name'] = "Dope", ['payment'] = true, ['perm'] = "dope.permissao" },
	[47] = { ['name'] = "Dust", ['payment'] = true, ['perm'] = "dust.permissao" },
	[50] = { ['name'] = "Mafia", ['payment'] = true, ['perm'] = "mafia.permissao" },
	[51] = { ['name'] = "Lifeinvader", ['payment'] = true, ['perm'] = "lifeinvader.permissao" },
	[52] = { ['name'] = "Corleone", ['payment'] = true, ['perm'] = "corleone.permissao" },
	[53] = { ['name'] = "Bratva", ['payment'] = true, ['perm'] = "bratva.permissao" },
	[54] = { ['name'] = "Corredores", ['payment'] = false, ['perm'] = "corredores.permissao" },
	[55] = { ['name'] = "Concessionaria", ['payment'] = false, ['public'] = true },
	[56] = { ['name'] = "Motorista", ['payment'] = false, ['perm'] = "livre" },
	...
	[61] = { ['name'] = "Fazendeiro", ['payment'] = false, ['perm'] = "livre" },
	[62] = { ['name'] = "Bicicleta", ['payment'] = false, ['public'] = true },
	[63] = { ['name'] = "Heliponto", ['payment'] = false, ['perm'] = "heli.permissao" },
	[64] = { ['name'] = "Heliponto", ['payment'] = false, ['perm'] = "heli.permissao" },
	[66] = { ['name'] = "Cayman", ['payment'] = false, ['perm'] = "cayman.permissao" },
	[67] = { ['name'] = "Loszetas", ['payment'] = false, ['perm'] = "loszetas.permissao" },
	[69] = { ['name'] = "Ilegais", ['payment'] = false, ['perm'] = "livre" },
-----------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------FORTHILLS-----------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	[162] = { ['name'] = "FH19", ['payment'] = false, ['public'] = false },
	...
	[207] = { ['name'] = "FH62", ['payment'] = false, ['public'] = false },
...
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	[608] = { ['name'] = "Exposicao", ['payment'] = false, ['perm'] = "admin.permissao" },
					...
					elseif parseInt(vehicle[1].detido) >= 1 then
						...
						if parseInt(os.time()) <= parseInt(vehicle[1].ipva+24*15*60*60) then
							...
							if vRP.vehicleType(tostring(name)) == "exclusive" or vRP.vehicleType(tostring(name)) == "rental" then
								...
								local price_tax = parseInt(vRP.vehiclePrice(name)*0) --isenção de Taxa
