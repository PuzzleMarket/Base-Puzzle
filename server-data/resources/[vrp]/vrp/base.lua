		...
		if user_id then
			...
			if not vRP.isBanned(user_id) then
				...
				if vRP.isWhitelisted(user_id) then
					...
					deferrals.done("Nosso servidor tem Whitelist! Entre no nosso Discord: https://discord.gg/geCwbn7 faça o formulário da Whitelist e após ser aprovado envie seu ID: "..user_id)
