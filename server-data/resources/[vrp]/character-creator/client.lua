...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	SetEntityCoordsNoOffset(PlayerPedId(),282.32,-583.8,43.29,true,true,true)
	...
	TriggerServerEvent("character-creator:finishedCharacter",characterNome,characterSobrenome,characterAge,currentCharacterMode)
end)
