...
AddEventHandler("nitro", function()
    ...
    if user_id then
        if vRP.tryGetInventoryItem(user_id,"nitro",1) then 
            TriggerClientEvent('puzzle:nitro', source)
            TriggerClientEvent("Notify",source,"sucesso","Você injetou nitro em seu veiculo.")
        else 
            TriggerClientEvent("Notify",source,"negado","Você nao possui nitro.")
        end
    end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
...
local salarios = {
	...
	{ ['permissao'] = "prata.permissao", ['nome'] = "PRATA", ['payment'] = 3000 },
	{ ['permissao'] = "ouro.permissao", ['nome'] = "OURO", ['payment'] = 6000 },
	{ ['permissao'] = "platina.permissao", ['nome'] = "PLATINA", ['payment'] = 9000 },
	-- Polícia -----------------------------------------------------------------------------
	{ ['permissao'] = "recruta.servico", ['nome'] = "RECRUTA", ['payment'] = 2000 },
	{ ['permissao'] = "soldado.servico", ['nome'] = "SOLDADO", ['payment'] = 2500 },
	{ ['permissao'] = "sargento.servico", ['nome'] = "SARGENTO", ['payment'] = 3500 },
	{ ['permissao'] = "tenente.servico", ['nome'] = "TENENTE", ['payment'] = 4500 },
	{ ['permissao'] = "capitao.servico", ['nome'] = "CAPITAO", ['payment'] = 5500 },
	{ ['permissao'] = "tencoronel.servico", ['nome'] = "TENCORONEL", ['payment'] = 6500 },
	{ ['permissao'] = "coronel.servico", ['nome'] = "CORONEL", ['payment'] = 8000 },
	-- Hospital -----------------------------------------------------------------------------
	...
	{ ['permissao'] = "diretor.servico", ['nome'] = "DIRETOR", ['payment'] = 8000 },

	{ ['permissao'] = "mecanico.permissao", ['nome'] = "MECANICO", ['payment'] = 2200 },
	...
	if user_id then
        ...
        if descricao == "" then
			...
			if resultado >= parseInt(args[2]) then
					...
					TriggerClientEvent("Notify",source,"sucesso","Efetuou o saque de <b>$"..vRP.format(parseInt(args[2])).."</b> da sua conta paypal.")
				else
		...
		elseif args[1] == "trans" and parseInt(args[2]) > 0 and parseInt(args[3]) > 0 then
			...
			if banco >= parseInt(args[3]) then
				--if vRP.request(source,"Deseja transferir <b>$"..vRP.format(parseInt(args[3])).."</b> para <b>"..identityu.name.." "..identityu.firstname.."</b> ?",30) then
					...
					TriggerClientEvent("Notify",source,"sucesso","Enviou <b>$"..vRP.format(parseInt(args[3])).."</b> ao passaporte <b>"..vRP.format(parseInt(args[2])).."</b>.")
					...
					if player == nil then
						...
						TriggerClientEvent("Notify",player,"importante","<b>"..identity.name.." "..identity.firstname.."</b> transferiu <b>$"..vRP.format(parseInt(args[3])).."</b> para sua conta do paypal.")
					end
				else
